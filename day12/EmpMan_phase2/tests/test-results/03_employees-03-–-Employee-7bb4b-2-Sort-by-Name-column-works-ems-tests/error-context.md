...
- Name: 03_employees.spec.js >> 03 – Employee Management Module >> EMP-12 Sort by Name column works
- Location: specs\03_employees.spec.js:120:3
...
Call log:
  - waiting for locator('th').filter({ hasText: 'Name' }).first()
