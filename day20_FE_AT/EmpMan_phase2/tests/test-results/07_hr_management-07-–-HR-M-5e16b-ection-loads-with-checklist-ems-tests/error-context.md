...
- Name: 07_hr_management.spec.js >> 07 – HR Management Module >> HR-08 Onboarding section loads with checklist
- Location: specs\07_hr_management.spec.js:65:3

# Error details

```
Error: locator.innerText: Error: strict mode violation: locator('.hr-module, [class*="hr"]') resolved to 10 elements:
    ...
    5) <button class="hr-nav-item active">…</button> aka getByRole('button', { name: 'Onboarding / Offboarding' })
    ...
    10) <div class="hr-content">…</div> aka locator('div').filter({ hasText: 'Employee Onboarding Checklist' }).nth(5)
      ...
      - generic [ref=e110]:
        ...
        - generic [ref=e115]:
          - navigation [ref=e116]:
            ...
            - button "Onboarding / Offboarding" [active] [ref=e122] [cursor=pointer]:
              - img [ref=e123]
          ...
          - generic [ref=e148]:
            - generic [ref=e149]:
              - heading "Employee Onboarding Checklist" [level=3] [ref=e150]
              - generic [ref=e151]:
                - generic [ref=e152]:
                  - generic [ref=e154]: ✓
                  - generic [ref=e155]: Send welcome email
                - generic [ref=e156]:
                  - generic [ref=e158]: ✓
                  - generic [ref=e159]: Set up workstation / IT access
                - generic [ref=e162]: Complete paperwork & contracts
                - generic [ref=e165]: HR orientation session
                - generic [ref=e168]: Introduction to team
                - generic [ref=e171]: Assign buddy / mentor
            - generic [ref=e172]:
              - heading "Employee Offboarding Checklist" [level=3] [ref=e173]
              - generic [ref=e174]:
                - generic [ref=e177]: Collect company assets
                - generic [ref=e180]: Revoke system access
                - generic [ref=e183]: Exit interview
                - generic [ref=e186]: Final payroll settlement
                - generic [ref=e189]: Knowledge transfer
```
